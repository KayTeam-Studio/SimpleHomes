...
public class HomesManager {
    ...
    public void loadMaxHomes() {
        ...
        for (String name: Objects.requireNonNull(settings.getFileConfiguration().getConfigurationSection("homes")).getKeys(false)) {
        ...
        if (essentials != null) {
            ...
            if (essentialsYaml.existFileConfiguration()) {
                ...
                if (essentialsYaml.contains("homes")) {
                    ...
                    for (String name: Objects.requireNonNull(essentialsYaml.getFileConfiguration().getConfigurationSection("homes")).getKeys(false)) {
