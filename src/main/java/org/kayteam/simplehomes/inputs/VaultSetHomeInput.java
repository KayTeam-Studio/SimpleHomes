...
public class VaultSetHomeInput implements ChatInput {

    private final SimpleHomes simpleHomes;

    public VaultSetHomeInput(SimpleHomes simpleHomes) {
    ...
    public boolean onChatInput(Player player, String input) {
        ...
        try {
            ...
            if (amount > 0) {
                ...
                settings.set("vault.setHome", amount);
                ...
                messages.sendMessage(player, "admin.vault.setHome.invalidAmount", new String[][] {{"%amount%", input}});
                return false;
            }
