...
public class VaultOverwriteHomeInput implements ChatInput {

    private final SimpleHomes simpleHomes;

    public VaultOverwriteHomeInput(SimpleHomes simpleHomes) {
    ...
    public boolean onChatInput(Player player, String input) {
        ...
        try {
            ...
            if (amount > 0) {
                ...
                messages.sendMessage(player, "admin.vault.overwriteHome.invalidAmount", new String[][] {
                        {"%amount%", input}
                });
                return false;
            }
